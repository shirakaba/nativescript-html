...
import { patchGestures } from './patchGestures';
...
export function patch(): void {
  ...
  // Patch the native gesture system to prevent parents recognizing gestures
  // when there's a child recognizing the same gesture (defer to DOM bubbling).
  patchGestures();
}
