...
const EventTargetImpl = require("../../../EventTarget").EventTarget;
...
class NodeImpl extends EventTargetImpl {
  ...
  get baseURI() {
    // NOT IMPLEMENTED
    notImplemented("node.baseURI", this._ownerDocument._defaultView);
    return "about:blank";
