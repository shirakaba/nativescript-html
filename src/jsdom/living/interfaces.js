...
// TODO: decide what we want to do about style. The relationship is: level2/style -> cssstyle > cssom.
// cssom is medium-sized, while cssstyle is fairly big.
// NativeScript exists a certain amount of Style, but it is almost certainly not spec-compliant to the same level.
...
const generatedInterfaces = {
  ...
  Document: require("./generated/Document"), // TODO: strip down
  ...
  // ProcessingInstruction: require("./generated/ProcessingInstruction"), // Would be easy to include, but no real feature gain
  Comment: require("./generated/Comment"),
  // DocumentType: require("./generated/DocumentType"), // Would be easy to include, but no real feature gain
