...
const EventTarget_1 = __importDefault(require("happy-dom/lib/event/EventTarget"));

var NotYetImplemented = "NativeScript DOM's FileReader API is not yet fully implemented.";
